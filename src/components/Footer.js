    ...
    <footer class="site-footer" id='contactus'>
      <div class="containerabove">
          <div class="footerabout">
            ...
            NuVision intends to transform traditional approach of therapy 
            into modern technological approach and firmly establish globally
            enabling individuals to instantly connect with licensed therapists and 
            counselors through secure video, phone, or chat sessions, thus
            providing individuals with convenient and affordable counseling on-demand.
            </p>
          </div>
